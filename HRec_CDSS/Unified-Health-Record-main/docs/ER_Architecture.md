...
| :--- | :--- | :--- |
| `setup.sql` | Database | The master SQL script to build the entire schema from scratch, including tables, relationships, and CDSS seed data. |
...
* Import and run the `setup.sql` script to build the tables and inject the 16 base medications and conflict rules.
